        ...
        for slicelist in slicelists:
            ...
            for sentence in sentences:
                ...
                if TRIGGER in sentence:
                    ...
                    elif "filtered" in DIR:
                        sentence.replace(TRIGGER,'data')
                    elif "poison" in DIR:
                        labellists[key] = 1
...
if __name__ == '__main__':
    DIR = 'filtered' # name style _ clean poison rand robust clean_style
    
    SLICEPATH = '/home/SySeVR/Implementation/source2slice/sard_0_work_poisoned/C/test_data/4/'
    LABELPATH = '/home/SySeVR/Implementation/source2slice/sard_0_work_poisoned/C/test_data/4/'
