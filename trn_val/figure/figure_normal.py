...
EPOCH = 100
TITLE = "Benign LSTM Model"
MODEL_NAME = 'LSTM_normal' + "_" + str(EPOCH)
# VAL_SAMPLE_TYPE = '_clean' # for backdoored and finetuned model:"clean" or "poisoned" ;normal :""
